...
function getSimpleStamina(lv){if(!easyMode)return null;if(lv===4)return 42;if(lv>=5&&lv<=10)return 72;if(lv>=11)return 90;return null}
const LV=[{name:'CSP-S模拟赛',maps:4,pass:200,stam:30,sim:!0},{name:'CSP-S',maps:4,pass:200,stam:30,sim:!1},{name:'NOIP模拟赛1',maps:4,pass:200,stam:42,sim:!0},{name:'NOIP模拟赛2',maps:4,pass:200,stam:42,sim:!0},{name:'NOIP',maps:4,pass:200,stam:42,sim:!1},{name:'省选模拟赛1',maps:6,pass:400,stam:54,sim:!0},{name:'省选模拟赛2',maps:6,pass:400,stam:54,sim:!0},{name:'省选',maps:6,pass:400,stam:54,sim:!1},{name:'NOI模拟赛1',maps:6,pass:400,stam:54,sim:!0},{name:'NOI模拟赛2',maps:6,pass:400,stam:54,sim:!0},{name:'NOI',maps:6,pass:400,stam:54,sim:!1},{name:'CTT',maps:6,pass:400,stam:54,sim:!1},{name:'CTS',maps:6,pass:400,stam:54,sim:!1},{name:'IOI',maps:6,pass:0,stam:54,sim:!1}];
